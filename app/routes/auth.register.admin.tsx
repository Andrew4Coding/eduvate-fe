...
export default function AdminRegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await authClient.signUp.email({
                ...
                onSuccess: async (ctx) => {
                    const response = await fetch(`${'http://localhost:8000/user/register-admin'}`, {
                        method: "POST",
                        headers: {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-white relative overflow-hidden">
            ...
            <Card className="w-full max-w-md shadow-lg border-0 bg-white/80 backdrop-blur-sm my-8">
                <CardHeader className="text-center">
                    <div className="flex items-center">
                        <Button variant="ghost" size="icon" className="absolute left-4" onClick={() => navigate("/auth")}>
                            <ArrowLeft className="h-5 w-5" />
                        </Button>
                        <CardTitle className="text-2xl font-bold text-gray-800 w-full">School Admin Registration</CardTitle>
                    </div>
                    <CardDescription className="text-gray-600">Create your school and admin account</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-1">
                            <h3 className="text-sm font-medium text-purple-600">Admin Information</h3>
                        ...
                        <div className="space-y-1 pt-2">
                            <h3 className="text-sm font-medium text-purple-600">School Information</h3>
                            <div className="h-px bg-gray-200 my-1"></div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-gray-500">
                                This code will be used by teachers and students to join your school.
                            </p>
                        </div>
                        <div className="space-y-2">
                        ...
                        <Button type="submit" className="w-full bg-purple-600 hover:bg-purple-700" disabled={isLoading}>
                            {isLoading ? "Registering..." : "Register School & Admin"}
                        </Button>
                    </form>
                </CardContent>
