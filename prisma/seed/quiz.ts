...
async function main() {
  ...
  const quiz = await prisma.quiz.create({
    data: {
      ...
      description:
        "Quiz ini mencakup penjumlahan, pengurangan, dan pembagian dasar.",
  ...
  const questions = [
    ...
    {
      question:
        "Jika kamu memiliki 50 apel dan memberikan 17 ke temanmu, berapa sisa apel yang kamu miliki?",
      answer: "33",
      correctAnswer: "33",
      options: ["30", "32", "33", "35"],
